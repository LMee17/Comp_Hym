#August 2022
#Individual species' gene-level DE analyses without removing outliers
...
#Converts transcript-level counts from input/ directory to a single counts table with 
#gene level estimates. Also generates a coldata object in the output directory
...
#Produce DDS object from tximport object (includes prefiltering and setting reference 
#condition to Naive)
...
##Ceratina australensis: all samples####
