...
#that are members of orthogroups that have representatives of all input species. 
#These are then collected into a folder reader to be read into tximport.
...
#and feed them into tximport in order to produce a list of txobjects 
#(one per input species). Coldata object is produced from file names.
...
#Produce DDS object from count table object (includes making coldata object from column 
#names, prefiltering and setting reference condition to Naive)
...
#Produce a dataframe with orthogroup and gene class information ready for data
#visualisation
...
##OrthoLevel DE: All Species (Aculeata)####
...
##OrthoLevel DE: All Bee (Anthophila) #####
...
##OrthoLevel DE: Apis and Bombus (Apinae)#####
###Preparing TX Object
...
##OrthoLevel DE: All Age-Controlled Species (AgeCont)####
